<div>
    ...
    <script>
      ...
      @include('livewire.frontend.layouts.partial.hero')
      @include('livewire.frontend.layouts.partial.about')
      @include('livewire.frontend.layouts.partial.members')
      @include('livewire.frontend.layouts.partial.gallery')
      @include('livewire.frontend.layouts.partial.activities')
      @include('livewire.frontend.layouts.partial.content')
