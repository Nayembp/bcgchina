<div>  
    <div class="mb-4 flex flex-col gap-2 px-5 sm:flex-row sm:items-center sm:justify-between sm:px-6">
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">
                Update this activity. Make sure it is unique!
            </p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow mb-2 mt-2">
        <h2 class="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-100">Edit Activity Type</h2>
        <form wire:submit.prevent="update" class="flex flex-col md:flex-row md:items-center md:space-x-4 space-y-3 md:space-y-0">
            <div class="flex flex-col">
                <flux:input.group>
                    <flux:input wire:model.debounce.500ms="activity_type" placeholder="Activity Type" />
