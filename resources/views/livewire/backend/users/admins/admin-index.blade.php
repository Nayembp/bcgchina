    ...
    <div class="mb-4 flex flex-col gap-2 px-5 sm:flex-row sm:items-center sm:justify-between sm:px-6">
      ...
      <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <div class="mt-3 sm:mt-0">
              ...
              <flux:button wire:navigate href="{{ route('admin.add') }}" size="sm">{{ __('Add Admin') }}</flux:button>                  
      ...
      <table class="min-w-full table-auto">
        <thead class="border-y border-gray-100 py-3 dark:border-gray-800">
          <tr>
            ...
            <th class="py-3 font-normal text-left whitespace-nowrap"> Adress </th>
            <th class="py-3 font-normal text-left whitespace-nowrap"> Donation </th>
        ...
        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
          @forelse ($admins as $admin)
            ...
            <tr class="align-top">
                <td class="py-4 px-3 whitespace-nowrap text-gray-800 dark:text-white">
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 overflow-hidden rounded-full">
                          <img src="{{ asset('storage/' . $admin->image) }}"  alt="brand">
                        </div>
                        <div>
              ...
              <td class="py-4 px-3 whitespace-nowrap text-gray-800 dark:text-white">
                Current address: {{ $admin->current_address }} <br>
                Permanent address: {{ $admin->permanent_address }} <br>
                University: {{ $admin->university }} <br>
              </td>
              <td class="py-4 px-3 whitespace-nowrap text-gray-800 dark:text-white">
                 {{ $admin->total_donation }}
              </td>
              <td class="py-4 px-3 whitespace-nowrap text-gray-800 dark:text-white">
              ...
              <td class="py-4 px-3 whitespace-nowrap">
                <div class="flex gap-2">
                  ...
                  @if(!$admin->hasRole('super-admin') && auth()->user()->can('user.delete'))    

                    <flux:button size="xs" variant="primary" icon="pencil" wire:navigate href="{{ route('admin.edit', $admin->id) }}" aria-label="Edit admin" />
